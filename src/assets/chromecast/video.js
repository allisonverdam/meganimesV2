...
MediaError.defaultMessages = {
  1: 'Você cancelou a execução do episódio',
  2: 'Ocorreu um erro ao baixar o episódio.',
  3: 'A reprodução da mídia foi interrompida devido a um problema de corrupção ou porque os recursos de mídia utilizados pelo navegador não eram compatíveis.',
  4: 'A mídia não pôde ser carregada, porque o servidor ou rede falhou ou porque o formato não é suportado.',
  5: 'Esse episódio esta encriptado e não temos a chave.'
};
...
var PosterImage = function (_ClickableComponent) {
  ...
  PosterImage.prototype.setSrc = function setSrc(url) {
    if (this.fallbackImg_) {
      ...
      this.el_.style.backgroundSize = 'cover';
